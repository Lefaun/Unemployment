...
# Example dataframe
df3 = pd.read_csv('Taxa de Desemprego.csv')
...
df4 = pd.read_csv('Taxa de Desemprego.csv')
Indx =  df4.get('Date1')
arr1  = df4.get('Homens')
...
df5 = pd.read_csv('Taxa de Desemprego.csv')
...
df6 = pd.read_csv("Taxa de Desemprego.csv")
